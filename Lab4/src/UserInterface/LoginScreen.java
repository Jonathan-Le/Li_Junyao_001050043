...
public class LoginScreen extends javax.swing.JPanel {
    ...
    JPanel panelRight;
    String group;
    public LoginScreen(String group, JPanel panelRight, List<User> list) {
        initComponents();
        this.list = list;
    ...
    private void initComponents() {
        ...
        txtTitle1.setText("Username");

        txtTitle2.setText("Password");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if ( list.get(comboUser.getSelectedIndex()).verify(txtPword.getText())) {
            CardLayout cardLayout = (CardLayout)panelRight.getLayout();
            panelRight.add(new SuccessScreen(list.get(comboUser.getSelectedIndex())));
