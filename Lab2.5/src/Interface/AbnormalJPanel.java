...
public class AbnormalJPanel extends javax.swing.JPanel {
     ...
     * @param defaultMin
     */
    public AbnormalJPanel(VitalSignHistory vsh, double defaultMax, double defaultMin) {
        initComponents();
        this.vsh = vsh;
        this.max=defaultMax;
        this.min=defaultMin;
...
//        dateTextField.setEnabled(false);
    ...
    private void detailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detailButtonActionPerformed
        this.SR = vitalSignsTable.getSelectedRow();
        
        if (SR >= 0) {
            VitalSigns vs = (VitalSigns) vitalSignsTable.getValueAt(SR, 0);
    ...
    private void ConfirmbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmbtnActionPerformed
        ...
        if(SR>=0){
            v= (VitalSigns) vitalSignsTable.getValueAt(SR, 0);
        ...
        for (VitalSigns v : vsh.getVitalSignHistory()) {
             if(v.getBloodPressure()<min || v.getBloodPressure()>max)
            { 
