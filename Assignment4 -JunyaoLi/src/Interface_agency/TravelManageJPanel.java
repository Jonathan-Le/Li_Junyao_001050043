...
public class TravelManageJPanel extends javax.swing.JPanel {
    ...
    public TravelManageJPanel (JPanel funcJpanel,MapStore mapstore) {
        initComponents();
        this.XJpanel = funcJpanel;
    ...
    private void initComponents() {
        ...
        airlinerjButton.setText("Airliner");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(customerjButton, javax.swing.GroupLayout.DEFAULT_SIZE, 131, Short.MAX_VALUE)
...
//       this.XJpanel.add(new AirlinerInfoJPanel(this.XJpanel, this.agency.getAirlinerMap(), this.customerMap));
...
//        cLayout.next(this.XJpanel);
    ...
    private void customerjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_customerjButtonActionPerformed
       this.XJpanel.add(new CustomerInfoJPanel(this.XJpanel, mapstore));
        CardLayout cLayout = (CardLayout) this.XJpanel.getLayout();
        cLayout.next(this.XJpanel);
